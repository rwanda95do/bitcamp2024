...
public class AddGame {
	 ...
	 * 제공한다. - 1문제당 점수 20점씩 처리한다. - 틀리면 1번 더 기회를 주고, 2번 다 틀리면 답을 알려준다. - Y/N은 대소문자
	 * 상관 없음. yn이 아니면 계속 반복
	 * 
	 ...
	 * 
	 * 또 할래(Y/N) : A 또 할래(Y/N) : w 또 할래(Y/N) : n
	 * 
	 * 프로그램을 종료합니다.
	 */
	public static void main(String[] args) {
		...
		EXIT: do {
			for (int j = 1; j <= 5; j++) { // 1번 FOR
				a = (int) (new Random().nextDouble() * 90 + 10);
				b = (int) (new Random().nextDouble() * 90 + 10);
